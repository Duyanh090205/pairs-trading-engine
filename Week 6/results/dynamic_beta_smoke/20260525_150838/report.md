...
|                 |   A0_static_v4 |   A1_short_ols60 |   B1_kalman_hl10 |
|:----------------|---------------:|-----------------:|-----------------:|
| (4, '2023-04')  |          5.959 |            3.381 |            6.37  |
| (5, '2023-05')  |         -9.196 |           -8.892 |           -9.247 |
| (18, '2024-06') |         -2.761 |           -2.841 |            3.86  |
| (22, '2024-10') |         -5.366 |           -4.599 |           -1.797 |
| (28, '2025-04') |          4.525 |            3.055 |            1.198 |
| (32, '2025-08') |         -2.807 |           -2.277 |            1.865 |

### Per-fold per-arm return (%)

|                 |   A0_static_v4 |   A1_short_ols60 |   B1_kalman_hl10 |
|:----------------|---------------:|-----------------:|-----------------:|
| (4, '2023-04')  |           2.26 |             1.68 |             0.59 |
| (5, '2023-05')  |         -22.1  |           -14.79 |           -16.13 |
| (18, '2024-06') |          -1.34 |            -1.07 |             0.45 |
| (22, '2024-10') |          -3.22 |            -2.6  |            -0.65 |
| (28, '2025-04') |           3.41 |             2.17 |             0.36 |
| (32, '2025-08') |          -5.38 |            -2.81 |             0.74 |
...
|:----------------|---------------:|-----------------:|-----------------:|
| (4, '2023-04')  |             70 |               78 |               35 |
| (5, '2023-05')  |            107 |              108 |              105 |
| (18, '2024-06') |            113 |              139 |               61 |
| (22, '2024-10') |            152 |              164 |               91 |
| (28, '2025-04') |             87 |              101 |               56 |
| (32, '2025-08') |            144 |              166 |               99 |
...
**Smoke-win**: B1_kalman_hl10. Proceed to full test.
